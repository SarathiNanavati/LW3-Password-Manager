...
export interface PasswordManagerInterface extends utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "getStreamId()": FunctionFragment;
    "isApprovedForAll(address,address)": FunctionFragment;
    "name()": FunctionFragment;
    "owner()": FunctionFragment;
    "ownerOf(uint256)": FunctionFragment;
    "ownerToToken(address)": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "safeSingleMint(string)": FunctionFragment;
    "safeTransferFrom(address,address,uint256)": FunctionFragment;
    "safeTransferFrom(address,address,uint256,bytes)": FunctionFragment;
    "setApprovalForAll(address,bool)": FunctionFragment;
    "setStream(uint256,string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "safeSingleMint",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "setStream", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "supportsInterface",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "StreamAdded(address,uint256,string)": EventFragment;
    "StreamUpdated(address,uint256,string,string)": EventFragment;
...
export interface PasswordManager extends BaseContract {
  ...
  functions: {
    ...
    getStreamId(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    ...
    "StreamAdded(address,uint256,string)"(
    ...
    "StreamUpdated(address,uint256,string,string)"(
      arg0?: PromiseOrValue<string> | null,
      tokenId?: null,
      oldStreamId?: null,
      newStreamId?: null
  ...
  estimateGas: {
    ...
    getStreamId(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getStreamId(overrides?: CallOverrides): Promise<PopulatedTransaction>;
